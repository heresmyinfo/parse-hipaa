'use strict'
// Custom GCSAdapter, copied from gcs-files-adapter and modified
...
// otherwise we serve the file through our express route `/hmfile` with image resize support
GCSAdapter.prototype.getFileLocation = function (config, filename) {
  ...
  return (process.env['WEB_SERVER_URL'] + '/hmfile/' + config.applicationId + '/' + encodeURIComponent(filename))
}
